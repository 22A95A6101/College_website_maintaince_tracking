      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/ceo"><b>CEO</b></a></li>
            <li><a class="dropdown-item" href="/lead">Team Lead</a></li>
            <li><a class="dropdown-item" href="/dev">Developer</a></li>
            <li><a class="dropdown-item" href="/clg">Representative</a></li>
          </ul>
        </li>
      </ul>
    </div>
